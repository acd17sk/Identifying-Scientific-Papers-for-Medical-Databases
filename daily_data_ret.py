...
handle = Entrez.esearch(db="pubmed", retmax=100000, term=query, datetype='edat', mindate='2021/01/05', maxdate='2021/01/06')
...
print(set(list(pubmed_data['DP'])))

pubmed_data.to_pickle('./unprocessed_daily_data.pkl')
